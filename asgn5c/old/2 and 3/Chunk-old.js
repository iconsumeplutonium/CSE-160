/*
Idea 2: Infinite procedurally generated 3D marching cubes terrain

The actual marching cubes algorithm worked. Abandoned because no matter what, the chunks wouldn't fucking match along chunk boundaries for some goddamn reason.
There would be massive gaps and holes between each chunk. 

Idea 3: 3D painting with marching cubes 

You would have a brush and you could add or subtract to a single plane to paint in 3D space. Abandoned because updating a mesh every frame kills frames. Only way for it to not be laggy
would be to break it into chunks, which as mentioned before, didn't work.
*/
